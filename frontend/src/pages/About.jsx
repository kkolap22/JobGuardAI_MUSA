...
import raghavPhoto from "../assets/raghav-lead.jpg";
  ...
  return (
    <Layout>
      ...
      <section className="hero-grid px-5 py-20 text-center lg:px-10">
        <Tag icon={UserRound}>THE PEOPLE BEHIND JOBGUARD AI</Tag>
        ...
        <p className="mx-auto mt-5 max-w-xl text-sm leading-7 text-slate-500">
          JobGuard AI is built by people passionate about technology,
